...
by Sergi Rubio Manrique, <mailto:srubio@cells.es>, with help from R.Bourtembourg
and E.Taurel.
...
Pogo generates method(s) named **DynAttr::add\_\<Dyn attr class name>\_dynamic_attribute(string att_name)**
...
method named **DynAttr::get\_\<Dyn attr class name>\_data_ptr(sting att_name)**. The user code simply pass this
