...
:::{tip}
Since cppTango 9.3.3, you can use the keywords 
...
*+inf*
 ...
 when writing double or float
scalar and array properties from jive to represent 
...
*+INF*
 ...
 are also supported for instance.
