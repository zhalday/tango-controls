---
substitutions:
  CPPTangoVersionBadge: |-
    ```{image} https://img.shields.io/github/release/tango-controls/cppTango.svg?style=flat
    :target: https://github.com/tango-controls/cppTango/releases/latest
    ```
  JTangoVersionBadge: |-
    ```{image} https://api.bintray.com/packages/tango-controls/generic/JTango-9-LTS/images/download.svg
    :target: https://bintray.com/tango-controls/generic/JTango-9-LTS/_latestVersion
    ```
  PyTangoVersionBadge: |-
    ```{image} https://img.shields.io/github/release/tango-controls/pyTango.svg?style=flat
    :target: https://github.com/tango-controls/pyTango/releases/latest
    ```
  TSDVersionBadge: |-
    ```{image} https://img.shields.io/github/release/tango-controls/TangoSourceDistribution.svg?style=flat
