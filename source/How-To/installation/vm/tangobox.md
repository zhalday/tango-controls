...
on for being explored, see [Switching containers on and off ](#container-switch-on-off)
...
- [Cumbia ](#cumbia)
- ITango
- [Sardana 2.7.0 ](#sardana)
- [PANIC/PyAlarm ](#panic)
- [Bensikin ](#hdb-tdb-snap)
- [Mambo ](#hdb-tdb-snap)
- Docker
- [Linac system simulation ](#jlinac) (as docker container tangobox-sim)
- [HDB/TDB, SNAP DS ](#hdb-tdb-snap) (as docker container tangobox-archiving)
- [HDB++ ](#hdbpp) (as docker container tangobox-hdbpp)
- [JupyTango ](#jupytango) (as docker container tangobox-jupytango)
- SerialLine, Modbus and PyPLC device server (as docker container tangobox-com)
- [mTango + restAPI ](#rest-api), [Tango WebApp ](#webapp) (as docker container tangobox-web)
- {ref}`e-giga` (as docker container tangobox-egiga)
- PyCharm
- [ModbusPal to simulate Modbus ](#Modbus)

## First steps

- First of all you have to download latest release of VirtualBox. It can be downloaded from [www.virtualbox.org](https://www.virtualbox.org/) .
...
[REST API documentation ](#tango-rest-api)
...
For more information about it please refer to [Sardana documentation](http://www.sardana-controls.org).
...
For more details please check Cumbia [webpage](https://elettra-sincrotronetrieste.github.io/cumbia-libs/)
and [source repository](https://github.com/ELETTRA-SincrotroneTrieste/cumbia-libs).
