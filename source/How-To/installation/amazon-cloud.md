...
An instance may be accessed with both [SSH access] or [Remote Desktop].
...
You can find out how to do this [here](http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/finding-an-ami.html#finding-an-ami-console).

Launch VM with this image and you will have TANGO 9.2.5 + PyTango 9.2.0 up and
running including the [TANGO REST API](http://tango-rest-api.readthedocs.io/en/latest/) so you can access it from internet.
...
To see the running DEMO, please, follow [the link](http://ec2-35-156-104-8.eu-central-1.compute.amazonaws.com:8080/TangoWebapp/). Use *tango-cs/tango* to login
