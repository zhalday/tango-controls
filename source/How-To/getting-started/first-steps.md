...
- If you would like to install Tango Controls please look on [Installation guides ](#getting-started-installation).

- To start connecting your devices to Tango Controls you should probably:

  > - browse [Device Classes Catalogue](http://www.tango-controls.org/developers/dsc/) to find device servers
  >   for your equipment
  ...
  >   [How to write your device class ](#how-to-write-first-device-class) if your device is not yet
...
- At the beginning you may also be interested in how to use provided tools:
  ...
  [Astor ](#astor-manual), [JDraw ](#jdraw-manual) or [Pogo ](#pogo-manual).
