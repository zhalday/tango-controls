...
- {doc}`Explanation <Explanation/introduction>`
- {doc}`Tutorials <Tutorials/index>`
- {doc}`How-Tos <How-To/index>`
...
> ```{eval-rst}
> +-------------------+----------------------------------+----------------------------------------+
> | **End user**      | :ref:`Index<users-docs>`         | :ref:`getting-started-as-user`         |
> +-------------------+----------------------------------+----------------------------------------+
> | **Beginner**      | :ref:`Index<gettingstartedtoc>`  | :ref:`first-steps`                     |
> +-------------------+----------------------------------+----------------------------------------+
> | **Developer**     | :ref:`Index<developers-docs>`    | :ref:`getting-started-as-developer`    |
> +-------------------+----------------------------------+----------------------------------------+
