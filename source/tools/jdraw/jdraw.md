...
Demo)](http://www.esrf.fr/computing/cs/tango/tango_doc/atk_tutorial/flash-demos/jdraw.htm)
...
4. Set the “LIBPATH” environment variable to the folder where is located
   your **“.lib”** file.
5. Start the jdraw java machine with “-DLIBPATH=\$LIBPATH”.
6. Note on the top right corner the “Palette Libraries” ComboBox. You
...
Demo)](http://www.esrf.fr/computing/cs/tango/tango_doc/atk_tutorial/flash-demos/jdraw_dyno.htm)
...
3. Click on the **“New”** button to add a new extension and give it
   the name **“className”**
4. Type in the fully defined class name of the panel you want to show,
   in the value field attached to **className** extension
5. Optionnally click on the **“New”** button to add another
...
[documentation]: http://www.esrf.eu/computing/cs/tango/tango_doc/kernel_doc/tango_java_api/classes/constant-values.html
