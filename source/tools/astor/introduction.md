...
substitutions:
  image0: |-
    ```{image} img/Astor-Starter.gif
    ```
  image1: |-
    ```{image} img/greenbal.gif
    ```
  image2: |-
    ```{image} img/blueball.gif
    ```
  image3: |-
    ```{image} img/orangebal.gif
    ```
  image4: |-
    ```{image} img/whiteball.gif
    ```
  image5: |-
    ```{image} img/redball.gif
    ```
  image6: |-
    ```{image} img/greenbal.gif
    ```
...
- On each host to be controlled, a device server (called [Starter](#Starter))
...
You can download the project [here](https://bintray.com/tango-controls/maven/Astor/_latestVersion)
