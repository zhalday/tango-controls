...
Tango REST API exports Tango hosts; Tango devices; Tango device attributes, commands and pipes. So it follows [Tango Device Server Model](#device-server).
...
The full reference can be found following this [link](http://tango-rest-api.readthedocs.io/en/latest)
...
Develop your REST client or use 3rd party frameworks.
